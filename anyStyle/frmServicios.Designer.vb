...
Partial Class frmServicios
    ...
    Private Sub InitializeComponent()
        ...
        Me.repCodigoServicio = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.repNombreServicio = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        ...
        Me.repDetalleCheck = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        ...
        Me.rowIDServicio = New DevExpress.XtraVerticalGrid.Rows.EditorRow()
        Me.rowCodigoServicio = New DevExpress.XtraVerticalGrid.Rows.EditorRow()
        Me.rowNombreServicio = New DevExpress.XtraVerticalGrid.Rows.EditorRow()
        Me.rowDetalleServicio = New DevExpress.XtraVerticalGrid.Rows.EditorRow()
        ...
        Me.repDetalleServicio = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        ...
        CType(Me.repCodigoServicio, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.repNombreServicio, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.repDetalleCheck, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.repDetalleServicio, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'pnlContenedor
        '
        ...
        SerializableAppearanceObject4.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(192, Byte), Integer))
        ...
        Me.vgrdDetalles.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.repActivo, Me.cboGrupoUsuarioCol, Me.repCodigoUsuario, Me.repCodigoServicio, Me.repNombreServicio, Me.repEmailUsuario, Me.repTelefonoProveedor, Me.repDetalleCheck, Me.repConfigurarUsuarios, Me.repDireccionProveedor, Me.repManejaCaja, Me.repManejaProductos, Me.repIndPerecedero, Me.repDireccion, Me.repDetalleServicio})
        Me.vgrdDetalles.RowHeaderWidth = 198
        Me.vgrdDetalles.Rows.AddRange(New DevExpress.XtraVerticalGrid.Rows.BaseRow() {Me.rowIDServicio, Me.rowCodigoServicio, Me.rowNombreServicio, Me.rowDetalleServicio, Me.rowIndActivo})
        ...
        'repCodigoServicio
        '
        Me.repCodigoServicio.AutoHeight = False
        Me.repCodigoServicio.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.repCodigoServicio.Mask.EditMask = "[0-9a-zA-Z]*"
        Me.repCodigoServicio.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.RegEx
        Me.repCodigoServicio.Mask.ShowPlaceHolders = False
        Me.repCodigoServicio.Mask.UseMaskAsDisplayFormat = True
        Me.repCodigoServicio.MaxLength = 50
        Me.repCodigoServicio.Name = "repCodigoServicio"
        '
        'repNombreServicio
        '
        Me.repNombreServicio.AutoHeight = False
        Me.repNombreServicio.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.repNombreServicio.Mask.EditMask = "[0-9a-zA-ZáéíóúÁÉÍÓÚ \-_#$%&]*"
        Me.repNombreServicio.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.RegEx
        Me.repNombreServicio.Mask.ShowPlaceHolders = False
        Me.repNombreServicio.Mask.UseMaskAsDisplayFormat = True
        Me.repNombreServicio.MaxLength = 50
        Me.repNombreServicio.Name = "repNombreServicio"
        '
        'repEmailUsuario
        '
        ...
        'repDetalleCheck
        '
        Me.repDetalleCheck.AutoHeight = False
        Me.repDetalleCheck.Caption = ""
        Me.repDetalleCheck.GlyphAlignment = DevExpress.Utils.HorzAlignment.Near
        Me.repDetalleCheck.Name = "repDetalleCheck"
        Me.repDetalleCheck.NullStyle = DevExpress.XtraEditors.Controls.StyleIndeterminate.Unchecked
        Me.repDetalleCheck.ValueGrayed = False
        '
        ...
        'rowIDServicio
        '
        Me.rowIDServicio.Name = "rowIDServicio"
        Me.rowIDServicio.Properties.Caption = "IDSERVICIO"
        Me.rowIDServicio.Properties.FieldName = "IDServicio"
        Me.rowIDServicio.Visible = False
        '
        'rowCodigoServicio
        '
        Me.rowCodigoServicio.Appearance.Options.UseTextOptions = True
        Me.rowCodigoServicio.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near
        Me.rowCodigoServicio.Height = 20
        Me.rowCodigoServicio.Name = "rowCodigoServicio"
        Me.rowCodigoServicio.Properties.Caption = "CÓDIGO"
        Me.rowCodigoServicio.Properties.FieldName = "CodigoServicio"
        Me.rowCodigoServicio.Properties.RowEdit = Me.repCodigoServicio
        '
        'rowNombreServicio
        '
        Me.rowNombreServicio.Appearance.Options.UseTextOptions = True
        Me.rowNombreServicio.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near
        Me.rowNombreServicio.Height = 20
        Me.rowNombreServicio.Name = "rowNombreServicio"
        Me.rowNombreServicio.Properties.Caption = "NOMBRE"
        Me.rowNombreServicio.Properties.FieldName = "NombreServicio"
        Me.rowNombreServicio.Properties.RowEdit = Me.repNombreServicio
        '
        'rowDetalleServicio
        '
        Me.rowDetalleServicio.Appearance.Options.UseTextOptions = True
        Me.rowDetalleServicio.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Top
        Me.rowDetalleServicio.Height = 100
        Me.rowDetalleServicio.Name = "rowDetalleServicio"
        Me.rowDetalleServicio.Properties.Caption = "DETALLE"
        Me.rowDetalleServicio.Properties.FieldName = "DetalleServicio"
        Me.rowDetalleServicio.Properties.RowEdit = Me.repDetalleServicio
        '
        'rowIndActivo
        '
        ...
        'repDetalleServicio
        '
        Me.repDetalleServicio.Name = "repDetalleServicio"
        '
        'frmServicios
        '
        ...
        CType(Me.repCodigoServicio, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.repNombreServicio, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.repDetalleCheck, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.repDetalleServicio, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents rowCodigoServicio As DevExpress.XtraVerticalGrid.Rows.EditorRow
    Friend WithEvents rowNombreServicio As DevExpress.XtraVerticalGrid.Rows.EditorRow
    ...
    Friend WithEvents repCodigoServicio As DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Friend WithEvents repNombreServicio As DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    ...
    Friend WithEvents rowDetalleServicio As DevExpress.XtraVerticalGrid.Rows.EditorRow
    Friend WithEvents repTelefonoProveedor As DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit
    Friend WithEvents repDetalleCheck As DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit
    ...
    Friend WithEvents rowIDServicio As DevExpress.XtraVerticalGrid.Rows.EditorRow
    Friend WithEvents repDetalleServicio As DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit
End Class
